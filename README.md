...
```bash
make build-base-image       # builds ineil77/sandbox-fusion-base:24042026-3 (all language runtimes)
make build-server-image     # builds ineil77/sandbox-fusion-server:24042026-3 (app + deps)
