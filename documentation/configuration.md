...
sandbox:
  ...
  docker_image: sandbox:base  # Docker image for "full" isolation mode
...
| `docker_image` | `string` | `"sandbox:base"` | Docker image used when `isolation` is `"full"`. Must have all language runtimes installed. |
