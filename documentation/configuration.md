...
sandbox:
  ...
  docker_image: ineil77/sandbox-fusion-server:24042026-4  # Docker image for "full" isolation mode
...
| `docker_image` | `string` | `"ineil77/sandbox-fusion-server:24042026-4"` | Docker image used when `isolation` is `"full"`. Must have all language runtimes installed. |
